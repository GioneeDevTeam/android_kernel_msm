...
static int16_t gn_sunny_ov8835_update_wb_register_from_otp(void)
{
	...
	return 0;//wangc_test_gn_sunny_ov8835_update_wb_register_from_otp invalid
	}
        if(gn_otp_wb_count <= 0) 
        {	

		if(!gn_sunny_ov8835_read_otp_wb(otp_index,current_otp_wb))//wangc added for checking read_otp_wb 
		{
		return 0;//wangc_test_gn_sunny_ov8835_update_wb_register_from_otp invalid
		}    
                gn_otp_wb_count++;        
...
//calculate gain
    ...
    return 1;//wangc_test_gn_sunny_ov8835_update_wb_register_from_otp invalid
}
...
static int16_t gn_sunny_ov8835_read_otp_lenc(int16_t index,struct gn_sunny_ov8835_otp_struct *otp)
{
	...
	//select 3rd bank
	bank++;
	gn_sunny_ov8835_write_cmos_sensor(0x3d84,bank);//wangc modifeid
...
static int16_t gn_sunny_ov8835_update_lenc_register_from_otp(void)
{
	...
	if(i == 4) //wangc modified
		{
			...
			return 0;//wangc_test_gn_sunny_ov8835_update_lenc_register_from_otp invalid
		}
	...
	return 1;// wangc_test_gn_sunny_ov8835_update_lenc_register_from_otp success
}
