...
#ifdef CONFIG_GN_Q_BSP_CONFIG_GPIO52_SUPPORT
static struct gpiomux_setting gpio_in_sleep_config = {
...
static struct msm_gpiomux_config gpio52_config __initdata = {
	.gpio = 52,
	.settings = {
		[GPIOMUX_ACTIVE]    = &gpio_in_sleep_config,
		[GPIOMUX_SUSPENDED] = &gpio_in_sleep_config,
	},
};
#endif
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
	...
	},
	{
		...
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_spi_cs1_config, //for es325 wakeup pin zhaocq20130803
...
//add by chenqiang for camera gpio control
...
#ifdef CONFIG_GN_Q_BSP_CONFIG_GPIO52_SUPPORT
	msm_gpiomux_install(&gpio52_config, 1);
#endif
